...
import { wholeCountries, nigerianStates } from "@/constants";
...
export const LocationForm = ({
	...
	async function onSubmit(data: z.infer<typeof FormSchema>) {
		try {
			...
			// return router.push(`/all-listings/new/${res?.space?._id}/amenities`);
		} catch (error) {
				...
				<form onSubmit={form.handleSubmit(onSubmit)}>
					...
					<Footer>
						<div className="container flex items-center justify-between gap-4">
							...
							>
								<Link
									href={`/all-listings/new/category?id=${spaceId}`}
								>
									Back
								</Link>
							</Button>
